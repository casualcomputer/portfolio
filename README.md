...
I help organizations translate AI business needs into software architecture, infrastructure decisions, and production systems.
...
[Discuss Your AI Project](#contact) | [View Engagements](#typical-engagements)
...
My focus is practical engineering. I work with teams to select the right architecture, evaluate infrastructure tradeoffs, improve AI performance, and deploy systems that are maintainable, scalable, and secure.

I have experience supporting enterprise AI initiatives, evaluating infrastructure proposals, researching hardware and software platforms, and matching technology stacks to real-world workloads including language models, speech AI, knowledge graphs, retrieval systems, agentic systems, and immersive applications.
...
Before hardware decisions, I help teams clarify the workload: expected users, concurrency, latency targets, model architecture, inference patterns, training or fine-tuning needs, framework choices, data sensitivity, deployment model, and integration requirements.

That includes understanding CUDA, ROCm, driver support, inference frameworks, model-serving requirements, and the software dependencies an organization may not realize will shape the hardware decision.

Software architecture comes first. Hardware follows from the workload.
...
The business outcome is straightforward: better user experience, higher platform capacity, and lower infrastructure cost before the next procurement decision.
...
My experience includes enterprise analytics, graph analytics, semantic and hybrid search, retrieval systems, explainable AI, enterprise knowledge systems, infrastructure evaluation, AI architecture communication, and production AI advisory for technical and executive audiences.
...
My consulting work is intentionally hands-on: clear technical reasoning, executive-ready communication, and implementation support when teams need to move from architecture to delivery.

I work as an independent, vendor-neutral advisor for organizations that need practical AI infrastructure and architecture guidance.
...
- **Focus areas:** AI architecture, multimodal AI, speech recognition, speech synthesis, virtual avatars, inference optimization, infrastructure planning, deployment architecture, latency reduction, and AI integration.
...
- **Lessons learned:** Multimodal AI succeeds when latency, orchestration, infrastructure, and user experience are designed together.
...
- **Focus areas:** Generative AI, hybrid search, retrieval systems, user question handling, public-service information access, and explainable answer design.
...
- **Lessons learned:** Useful government AI depends on retrieval quality, user trust, and clear boundaries around what the system can and cannot answer.
...
- **Focus areas:** Private LLMs, retrieval, local inference, AI workflow design, deployment planning, and executive communication.
...
- **Lessons learned:** Private AI depends on governance, deployment discipline, and maintainability as much as model selection.
...
- **Focus areas:** Semantic search, hybrid search, graph analytics, text analytics, enterprise data exploration, and retrieval design.
- **Outcome:** Improved discovery workflows and supported more efficient analysis of enterprise information assets.
- **Lessons learned:** Search quality improves when retrieval design, metadata, user workflows, and data quality are treated as one system.
...
- **Focus areas:** Document parsing, LLM-assisted review, web application deployment, backend services, and Linux server operations.
- **Outcome:** Created a practical compliance checker with an independently managed production workflow.
- **Lessons learned:** AI-assisted document review works best when extraction quality, clear user feedback, and careful deployment operations are designed together.
...
- [Read the Reddit post](https://www.reddit.com/r/LocalLLaMA/comments/1o9it7v/benchmark_visualization_rtx_pro_6000_vs_dgx_spark/)
- [View the chart repository](https://github.com/casualcomputer/rtx_pro_6000_vs_dgx_spark)
...
- [View on GitHub](https://github.com/casualcomputer/evaluation-ai-pro)
...
- [View on GitHub](https://github.com/casualcomputer/llm_google_colab)
...
- [View on GitHub](https://github.com/casualcomputer/sql.mechanic)

## Blog

Technical writing and notes are available at [Journal Learn](https://journallearn.wordpress.com/).
...
- Name: Henry Luan
- Email: [info@sonarwave.org](mailto:info@sonarwave.org)
- Website: [www.bigkpi.com](https://www.bigkpi.com)
- GitHub: [casualcomputer](https://github.com/casualcomputer)
- Blog: [Journal Learn](https://journallearn.wordpress.com/)
